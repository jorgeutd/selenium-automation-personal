...
if __name__ == '__main__':
    ...
    #flights, wrappers = scrapper.get_flights('CMH', 'ROM', '2023-07-12', '2023-07-19', load_attemps=2)
    origin_cities = ['CMH']
    destination_cities = ['ROM']
    departure_dates = ['2023-07-12']#, '2023-07-18', '2023-07-14', '2023-07-17']
    return_dates = ['2023-07-17']#, '2023-07-22', '2023-07-23', '2023-07-24']
